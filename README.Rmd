...
Next, we prune the tree. The package includesd 2 functions to do so: `tune_cp` and `cp_elbow`. We'll use the `cp_elbow` function which uses the elbow method along with elbow strength to find the optimal cp:
